...
class McRealPostState extends State<McRealPost> {
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: GestureDetector(
        onTap: ownPost && widget.userData['mcRealStatus'] == McRealStatus.REMOVED ? openPostRemovedPopup : () {},
        child: Container(
          padding: EdgeInsets.only(top: ownPost && widget.userData['mcRealStatus'] != McRealStatus.OK ? 12 : 5, left: 12, right: 12, bottom: ownPost && widget.userData['mcRealStatus'] != McRealStatus.OK ? 12 : 0),
          decoration: BoxDecoration(
              borderRadius: BorderRadius.circular(10),
              color: McRealColors.darkerBackground),
          child: ownPost && widget.userData['mcRealStatus'] == McRealStatus.REMOVED ? Row(
          ...
          ) : ownPost && widget.userData['mcRealStatus'] == McRealStatus.DELETED ? Row(
            mainAxisAlignment: MainAxisAlignment.start,
            crossAxisAlignment: CrossAxisAlignment.center,
            children: [
              const Icon(Icons.info, color: McRealColors.blue, size: 25),
              const SizedBox(width: 10),
              Text(AppLocalizations.of(context)!.mcReal_status_deleted,
                  style: const TextStyle(
                      fontSize: 15, fontWeight: FontWeight.w500)),
            ]
          ) : Column(
            ...
            children: [
              ...
              Stack(children: [
                      ...
                      child: ClipRRect(
                          ...
                          child: Stack(
                            children: [
                              ...
                              if (!(primary is Center || secondary is Center))
                                Positioned(
                              ...
                              if (!ownPost &&
                                  !(primary is Center || secondary is Center))
                                Positioned(
                                    bottom: 10,
                                    right: 10,
                                    child: NoRiskIconButton(
                ...
                if (widget.locked && widget.userData['mcRealStatus'] == McRealStatus.REMOVED)
                  GestureDetector(
  ...
  String getPostTime() {
    ...
    Duration difference = uploadTime.subtract(Duration(minutes: Config.mcRealTimeframe)).difference(mcRealTime);
          ...
          return Platform.isAndroid
              ? AlertDialog(
                  ...
                  content: Text('${AppLocalizations.of(context)!
                      .mcReal_removedPostReason}: ${widget.postData['mcRealStatusInfo']}'),
                  actions: [
                    TextButton(
              ...
              : CupertinoAlertDialog(
                  title: Text(AppLocalizations.of(context)!
                      .mcReal_removedPostPopupTitle),
                  content: Text('${AppLocalizations.of(context)!
                      .mcReal_removedPostReason}: ${widget.userData['mcRealStatusInfo']}'),
                  actions: [
